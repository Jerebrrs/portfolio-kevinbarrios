            ...
            <div className="container mx-auto">
                <div className='flex justify-between gap-x-8'>
                    ...
                    xl:text-left'>
                        ...
                        <p className='subtitle max-w-[490px] mx-auto xl:mx-0'>Soy desarrollador web con una formación en Ciencias Económicas. Esto me ha ayudado a fortalecer habilidades como el pensamiento lógico y la resolución de problemas, aplicándolas en distintos entornos de desarrollo.</p>
                        <div className='flex flex-col gap-y-3 md:flex-row gap-x-3 mx-auto xl:mx-0 mb-12'>
                            <Link href={'/contact'}>
                                <Button className=' gap-x-2'>Contactame <Send size={18} /></Button>
                            </Link>
                            <Link href='/CV.pdf' passHref download={true} target="_blank" >
